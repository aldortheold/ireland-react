...
function Builder(props) {
    ...
    return (
        <div className="container">
            ...
            <div className="image">
                <img src={`/${props.index}_1.jpg`} alt={images[props.index]} title={images[props.index]} />
            </div>
            <div className="image">
                <img src={`/${props.index + 1}_1.jpg`} alt={images[props.index + 1]} title={images[props.index + 1]} />
            </div>
            <div className="text">
